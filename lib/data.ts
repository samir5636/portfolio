...
export const EducationData = [
  {
    ...
    description:
      'Completed a rigorous curriculum focusing on physical sciences, laying the foundation for further studies in engineering and technology.',
    date: '2019 - 2020',
  },
  {
    title: 'DEUST in Mathematics, Computer Science, Physics, Chemistry',
    location: 'Faculty of Sciences and Technology, Tangier, Morocco',
    description:
